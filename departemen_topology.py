...
class MedicalSimpleTopo(Topo):
    def build(self):
        ...
        h_mhs_wifi_1 = self.addHost('mhs1', ip='172.16.9.1/16')
        h_mhs_wifi_2 = self.addHost('mhs2', ip='172.16.9.2/16')
        self.addLink(s_g9_lt1, h_mhs_wifi_1)
        self.addLink(s_g9_lt1, h_mhs_wifi_2)

        # IP Kabel Gedung G9 Lantai 1: 172.16.12.0/27
        h_mhs_kabel_1 = self.addHost('mhsc1', ip='172.16.12.1/16')
        h_mhs_kabel_2 = self.addHost('mhsc2', ip='172.16.12.2/16')
        ...
        h_mhs_wifi_lt2_1 = self.addHost('mhs2a', ip='172.16.10.1/16')
        h_mhs_wifi_lt2_2 = self.addHost('mhs2b', ip='172.16.10.2/16')
        ...
        h_keu_1 = self.addHost('keu1', ip='172.16.12.33/16')
        h_keu_2 = self.addHost('keu2', ip='172.16.12.34/16')
        ...
        h_dekan = self.addHost('dekan', ip='172.16.12.35/16')
        h_sekre = self.addHost('sekre', ip='172.16.12.36/16')
        ...
        h_dsn_g9_1 = self.addHost('dsn9a', ip='172.16.12.37/16')
        h_dsn_g9_2 = self.addHost('dsn9b', ip='172.16.12.38/16')
        ...
        h_ujian_1 = self.addHost('ujian1', ip='172.16.12.39/16')
        h_ujian_2 = self.addHost('ujian2', ip='172.16.12.40/16')
        ...
        h_mhs_3a = self.addHost('mhs3a', ip='172.16.11.1/16')
        h_mhs_3b = self.addHost('mhs3b', ip='172.16.11.2/16')
        ...
        h_lab1_a = self.addHost('lab1a', ip='172.16.12.65/16')
        h_lab1_b = self.addHost('lab1b', ip='172.16.12.66/16')
        ...
        h_lab2_a = self.addHost('lab2a', ip='172.16.12.67/16')
        h_lab2_b = self.addHost('lab2b', ip='172.16.12.68/16')
        ...
        h_lab3_a = self.addHost('lab3a', ip='172.16.12.69/16')
        h_lab3_b = self.addHost('lab3b', ip='172.16.12.70/16')
        ...
        h_adm_g10_1 = self.addHost('adm10a', ip='172.16.21.129/16')
        h_adm_g10_2 = self.addHost('adm10b', ip='172.16.21.130/16')
        ...
        h_mhs_g10_lt2_1 = self.addHost('mhsg10_2a', ip='172.16.20.129/16')
        h_mhs_g10_lt2_2 = self.addHost('mhsg10_2b', ip='172.16.20.130/16')
        ...
        h_dsn_10a_1 = self.addHost('dsn10a1', ip='172.16.21.161/16')
        h_dsn_10a_2 = self.addHost('dsn10a2', ip='172.16.21.162/16')
        h_aula_1 = self.addHost('aula1', ip='172.16.21.163/16')
        h_aula_2 = self.addHost('aula2', ip='172.16.21.164/16')
        ...
        h_mhs_g10_lt3_1 = self.addHost('mhsg10_3a', ip='172.16.21.1/16')
        h_mhs_g10_lt3_2 = self.addHost('mhsg10_3b', ip='172.16.21.2/16')
        ...
        h_dsn_10b_1 = self.addHost('dsn10b1', ip='172.16.21.177/16')
        h_dsn_10b_2 = self.addHost('dsn10b2', ip='172.16.21.178/16')
