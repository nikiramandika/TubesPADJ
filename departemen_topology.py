...
class MedicalSimpleTopo(Topo):
    def build(self):
        ...
        ap_g9_lt1 = self.addSwitch('s4') 
        self.addLink(s_dist_g9, ap_g9_lt1)
        
        h_mhs_wifi_1 = self.addHost('mhs1', ip='10.0.0.101/24')
        h_mhs_wifi_2 = self.addHost('mhs2', ip='10.0.0.102/24')
        self.addLink(ap_g9_lt1, h_mhs_wifi_1)
        self.addLink(ap_g9_lt1, h_mhs_wifi_2)
        ...
        # Lab 2 (Switch tersendiri -> ke Main Lt3)
        ...
        # Lab 3 (Switch tersendiri -> ke Main Lt3)
        ...
        # Access Point Mahasiswa Lt3 (Langsung ke Switch Main Lt3)
...
def run():
    ...
    net.start()
    print("[+] Updated Topology: G9 Lt3 has 3 Labs (separate switches) + AP hosts (direct to main switch).")
    CLI(net)
    net.stop()
